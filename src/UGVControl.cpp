...
//#include <std_msgs/Float64.h>
       ...
       /* std_msgs::Float64 UGVControl::battery()
        {
            direction_x_ = system("rostopic echo -n 1 /status/charge_estimate");
            batt = system("rostopic echo -n 1 /status/charge_estimate");
            batt = 100;
            ROS_WARN_STREAM(batt);
            return direction_x_;
        } */
